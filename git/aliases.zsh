...
alias gdside="git -c delta.side-by-side=true diff"
alias gdsside="git -c delta.side-by-side=true diff --staged"
alias gdiff="git diff"
alias gdiffs="git diff --staged"
alias gdiffside="git -c delta.side-by-side=true diff"
alias gdiffsside="git -c delta.side-by-side=true diff --staged"
...
# forgit (interactive, fzf-powered)
